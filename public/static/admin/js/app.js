...
var App = function() {
    ...
    var uiHelperDatepicker = function(){
        ...
        jQuery('.js-datepicker').add('.input-daterange').each(function () {
            ...
            var $startView = $datepicker.data('start-user') === undefined ? 0 : $datepicker.data('start-user');
            var $minViewMode = $datepicker.data('min-user-mode') === undefined ? 0 : $datepicker.data('min-user-mode');
            var $maxViewMode = $datepicker.data('max-user-mode') === undefined ? 4 : $datepicker.data('max-user-mode');
