...
window.onload = function () {
    ...
    $( "#scrollBed .user-box:eq("+ currentChartType +")" ).trigger( "click" );
...
function initChartsTypeView () {
    ...
    for ( var i = 0, len = chartsConfig.length; i<len; i++ ) {
        ...
        contents.push( '<div class="user-box" data-chart-type="'+ i +'"><img width="300" src="images/charts'+ i +'.png"></div>' );
...
function initEvent () {
    ...
    var cacheValue = null,
        ...
        $chartsTypeViewBox = $( '#scrollBed .user-box' );
    ...
    $( ".table-user" ).delegate( ".data-item", "focus", function () {
    ...
    //图表类型变化
    $( '#scrollBed' ).delegate( ".user-box", "click", function (e) {
